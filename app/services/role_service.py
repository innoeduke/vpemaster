from app import db
from app.models import SessionLog, SessionType, Waitlist, Roster, Role, Contact, Meeting
...
class RoleService:
    ...
    def join_waitlist(session_log, contact_id):
        ...
        for s_id in session_ids:
            ...
            if not exists:
                wl = Waitlist(session_log_id=s_id, contact_id=contact_id, timestamp=datetime.utcnow())
                db.session.add(wl)
                added = True
