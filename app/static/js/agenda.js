document.addEventListener("DOMContentLoaded", () => {
  ...
  const ST_GROUP_META = [
    ...
    { key: "Educational",                 icon: "fa-graduation-cap", iconClass: "st-icon--educational", subtitle: "Roles focused on education and training." },
  ...
  function classifySessionType(t) {
    ...
    if (rg === "educational") return "Educational";
