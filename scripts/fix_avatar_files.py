...
def fix_avatar_files(apply=False):
    app = create_app()
    with app.app_context():
        ...
        # Sort by ID descending to avoid overwriting during rename
        ...
        for f in files:
            ...
            # Skip files updated today (like Alice's)
            if mtime.date() >= today:
        ...
        if not apply:
            ...
            print("\nDry run complete. Use --apply to perform renames.")
            return
