...
class TestRoleService(unittest.TestCase):
    def setUp(self):
        ...
        # Create Basic Data
        self.meeting = Meeting(Meeting_Number=1, Meeting_Date=datetime.utcnow(), Status='running')
        ...
        # Refresh IDs
        self.tm_type = SessionType(role_id=self.role_tm.id, name="Toastmaster Type")
        self.spk_type = SessionType(role_id=self.role_spk.id, name="Speaker Type")
