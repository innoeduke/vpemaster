...
class TestContactClubJunctionTable:
    ...
    def test_contact_clubs_table_exists(self, app, default_contact_club):
    ...
    def test_contact_club_has_required_fields(self, app, default_contact_club):
...
class TestMeetingClubRelationship:
    ...
    def test_all_meetings_have_club_id(self, app, default_club):
        """Test that all meetings have club_id assigned."""
        with app.app_context():
            # Create a meeting if none exists (though we are mainly testing schema here)
    ...
    def test_meeting_club_relationship(self, app, default_club):
    ...
    def test_meeting_club_id_foreign_key(self, app, default_club):
...
class TestContactClubMethods:
    ...
    def test_get_primary_club(self, app, default_contact_club):
    ...
    def test_get_clubs(self, app, default_contact_club):
    ...
    def test_get_club_membership(self, app, default_contact_club):
    ...
    def test_get_club_membership_nonexistent(self, app, default_contact):
...
class TestContactClubRelationships:
    ...
    def test_contact_club_contact_relationship(self, app, default_contact_club):
        """Test ContactClub.contact relationship."""
        with app.app_context():
            # Merge the detached object back into the session
            cc = db.session.merge(default_contact_club)
            assert cc is not None
    ...
    def test_contact_club_club_relationship(self, app, default_contact_club):
...
class TestMultiClubDataIntegrity:
    ...
    def test_no_orphaned_contact_clubs(self, app, default_contact_club):
    ...
    def test_club_has_meetings(self, app, default_club):
    ...
    def test_contact_club_to_dict(self, app, default_contact_club):
