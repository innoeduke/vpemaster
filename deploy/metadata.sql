...
--
-- Host: 127.0.0.1    Database: vpemaster
-- ------------------------------------------------------
...
VALUES (
  ...
  (5, 'Guest', NULL, 0, '2026-01-16 13:55:24');
/*!40000 ALTER TABLE `auth_roles` ENABLE KEYS */
;
UNLOCK TABLES;
--
-- Table structure for table `level_roles`
--
...
;
--
-- Dumping data for table `level_roles`
--

LOCK TABLES `level_roles` WRITE;
/*!40000 ALTER TABLE `level_roles` DISABLE KEYS */
;
INSERT INTO `level_roles`
VALUES (1, 1, 'Topics Speaker', 'required', 1, NULL),
  (
    2,
    1,
  ...
  (3, 1, 'Timer', 'elective', 1, NULL),
  (4, 1, 'Ah-Counter', 'elective', 1, NULL),
  (5, 2, 'Grammarian', 'required', 1, NULL),
  (6, 2, 'Topicsmaster', 'required', 1, NULL),
  (
    7,
    2,
    'Individual Evaluator',
  ...
  (8, 2, 'TME', 'elective', 1, NULL),
  (9, 2, 'Timer', 'elective', 1, NULL),
  (10, 2, 'Ah-Counter', 'elective', 1, NULL),
  (11, 3, 'TME', 'required', 1, NULL),
  (
    12,
    3,
    'Individual Evaluator',
  ...
  (13, 3, 'Topicsmaster', 'elective', 1, NULL),
  (14, 3, 'Topics Speaker', 'elective', 1, NULL),
  (
    15,
    3,
    'Introductory Mentor',
  ...
  (16, 4, 'TME', 'required', 1, NULL),
  (17, 4, 'GE', 'required', 1, NULL),
  (
    18,
    4,
    'Individual Evaluator',
  ...
  (19, 4, 'Topicsmaster', 'elective', 1, NULL),
  (20, 4, 'Topics Speaker', 'elective', 1, NULL),
  (21, 4, 'Photographer', 'elective', 1, NULL),
  (22, 4, 'Welcome Officer', 'elective', 1, NULL),
  (23, 4, 'Meeting Manager', 'elective', 1, NULL),
  (24, 4, 'Debater', 'elective', 1, NULL),
  (25, 4, 'Panelist', 'elective', 1, NULL),
  (26, 5, 'TME', 'required', 2, NULL),
  (27, 5, 'GE', 'required', 2, NULL),
  (
    28,
    5,
    'Individual Evaluator',
  ...
  (29, 5, 'Topicsmaster', 'elective', 1, NULL),
  (30, 5, 'Topics Speaker', 'elective', 1, NULL),
  (31, 5, 'Timer', 'elective', 1, NULL),
  (32, 5, 'Ah-Counter', 'elective', 1, NULL),
  (33, 5, 'Grammarian', 'elective', 1, NULL),
  (34, 5, 'Photographer', 'elective', 1, NULL),
  (35, 5, 'Club Mentor', 'elective', 1, NULL),
  (36, 5, 'Welcome Officer', 'elective', 1, NULL),
  (37, 5, 'Meeting Manager', 'elective', 1, NULL),
  (38, 5, 'Debater', 'elective', 1, NULL),
  (39, 5, 'Panelist', 'elective', 1, NULL),
  (
    64,
    3,
  ...
  (69, 1, 'Elective Pool', 'elective', 1, NULL),
  (70, 2, 'Elective Pool', 'elective', 1, NULL),
  (71, 3, 'Elective Pool', 'elective', 1, NULL),
  (72, 4, 'Elective Pool', 'elective', 2, NULL),
  (73, 5, 'Elective Pool', 'elective', 2, NULL);
/*!40000 ALTER TABLE `level_roles` ENABLE KEYS */
;
UNLOCK TABLES;
--
...
CREATE TABLE `meeting_roles` (
  ...
  `award_category` varchar(30) DEFAULT NULL,
  `needs_approval` tinyint(1) NOT NULL,
  `has_single_owner` tinyint(1) NOT NULL,
  `is_member_only` tinyint(1) DEFAULT NULL,
  PRIMARY KEY (`id`)
...
VALUES (0, 'No Role', NULL, 'system', NULL, 0, 1, NULL),
  (
    1,
    'Toastmaster',
    'fa-microphone',
  ...
  (31, 'SAA', '', 'officer', '', 0, 0, 0),
  (32, 'President', '', 'officer', '', 0, 0, 0),
  (33, 'VPE', '', 'officer', '', 0, 0, 0),
  (34, 'VPM', '', 'officer', '', 0, 0, 0),
  (35, 'VPPR', '', 'officer', '', 0, 0, 0),
  (36, 'Secretary', '', 'officer', '', 0, 0, 0),
  (37, 'Treasurer', '', 'officer', '', 0, 0, 0);
/*!40000 ALTER TABLE `meeting_roles` ENABLE KEYS */
;
UNLOCK TABLES;
--
-- Table structure for table `pathway_projects`
--

DROP TABLE IF EXISTS `pathway_projects`;
/*!40101 SET @saved_cs_client     = @@character_set_client */
;
/*!50503 SET character_set_client = utf8mb4 */
;
CREATE TABLE `pathway_projects` (
  ...
  `type` enum('elective', 'required', 'other') NOT NULL DEFAULT 'required',
  `level` int DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `path_id` (`path_id`),
  KEY `pathway_projects_ibfk_2` (`project_id`),
  CONSTRAINT `pathway_projects_ibfk_1` FOREIGN KEY (`path_id`) REFERENCES `pathways` (`id`),
  CONSTRAINT `pathway_projects_ibfk_2` FOREIGN KEY (`project_id`) REFERENCES `Projects` (`id`)
) ENGINE = InnoDB AUTO_INCREMENT = 289 DEFAULT CHARSET = utf8mb3;
/*!40101 SET character_set_client = @saved_cs_client */
;
--
-- Dumping data for table `pathway_projects`
--

LOCK TABLES `pathway_projects` WRITE;
/*!40000 ALTER TABLE `pathway_projects` DISABLE KEYS */
;
INSERT INTO `pathway_projects`
VALUES (1, 1, 1, '1.1', 'required', 1),
  (2, 1, 2, '1.2', 'required', 1),
  (3, 1, 3, '1.3', 'required', 1),
  (4, 1, 4, '1.4.1', 'required', 1),
  (5, 1, 5, '1.4.2', 'required', 1),
  (6, 1, 6, '1.4.3', 'required', 1),
  (7, 1, 7, '3.2', 'elective', 3),
  (8, 1, 8, '2.2', 'required', 2),
  (9, 1, 9, '2.1', 'required', 2),
  (10, 1, 10, '3.2', 'elective', 3),
  (11, 1, 11, '3.2', 'elective', 3),
  (12, 1, 12, '3.2', 'elective', 3),
  (13, 1, 13, '2.3', 'required', 2),
  (14, 1, 16, '3.1', 'required', 3),
  (15, 1, 20, '3.2', 'elective', 3),
  (16, 1, 21, '3.2', 'elective', 3),
  (17, 1, 22, '3.2', 'elective', 3),
  (18, 1, 23, '3.2', 'elective', 3),
  (19, 1, 24, '3.2', 'elective', 3),
  (20, 1, 25, '3.2', 'elective', 3),
  (21, 1, 26, '3.2', 'elective', 3),
  (22, 1, 27, '3.2', 'elective', 3),
  (23, 1, 28, '3.2', 'elective', 3),
  (24, 1, 29, '3.2', 'elective', 3),
  (25, 1, 30, '3.2', 'elective', 3),
  (26, 1, 33, '4.1', 'required', 4),
  (27, 1, 37, '4.2', 'elective', 4),
  (28, 1, 38, '4.2', 'elective', 4),
  (29, 1, 39, '4.2', 'elective', 4),
  (30, 1, 40, '4.2', 'elective', 4),
  (31, 1, 41, '4.2', 'elective', 4),
  (32, 1, 42, '4.2', 'elective', 4),
  (33, 1, 43, '4.2', 'elective', 4),
  (34, 1, 44, '4.2', 'elective', 4),
  (35, 1, 48, '5.2', 'elective', 5),
  (36, 1, 49, '5.2', 'elective', 5),
  (37, 1, 50, '5.1', 'required', 5),
  (38, 1, 51, '5.2', 'elective', 5),
  (39, 1, 53, '5.3', 'required', 5),
  (40, 1, 54, '5.2', 'elective', 5),
  (41, 1, 55, '5.2', 'elective', 5),
  (42, 1, 56, '5.2', 'elective', 5),
  (43, 1, 57, '5.2', 'elective', 5),
  (44, 2, 1, '1.1', 'required', 1),
  (45, 2, 2, '1.2', 'required', 1),
  (46, 2, 3, '1.3', 'required', 1),
  (47, 2, 4, '1.4.1', 'required', 1),
  (48, 2, 5, '1.4.2', 'required', 1),
  (49, 2, 6, '1.4.3', 'required', 1),
  (50, 2, 7, '2.1', 'required', 2),
  (51, 2, 10, '3.2', 'elective', 3),
  (52, 2, 11, '2.2', 'required', 2),
  (53, 2, 12, '3.2', 'elective', 3),
  (54, 2, 13, '2.3', 'required', 2),
  (55, 2, 15, '3.1', 'required', 3),
  (56, 2, 20, '3.2', 'elective', 3),
  (57, 2, 21, '3.2', 'elective', 3),
  (58, 2, 22, '3.2', 'elective', 3),
  (59, 2, 23, '3.2', 'elective', 3),
  (60, 2, 24, '3.2', 'elective', 3),
  (61, 2, 25, '3.2', 'elective', 3),
  (62, 2, 26, '3.2', 'elective', 3),
  (63, 2, 27, '3.2', 'elective', 3),
  (64, 2, 28, '3.2', 'elective', 3),
  (65, 2, 29, '3.2', 'elective', 3),
  (66, 2, 30, '3.2', 'elective', 3),
  (67, 2, 34, '4.2', 'elective', 4),
  (68, 2, 36, '4.1', 'required', 4),
  (69, 2, 37, '4.2', 'elective', 4),
  (70, 2, 38, '4.2', 'elective', 4),
  (71, 2, 39, '4.2', 'elective', 4),
  (72, 2, 40, '4.2', 'elective', 4),
  (73, 2, 41, '4.2', 'elective', 4),
  (74, 2, 42, '4.2', 'elective', 4),
  (75, 2, 43, '4.2', 'elective', 4),
  (76, 2, 44, '4.2', 'elective', 4),
  (77, 2, 45, '5.1', 'required', 5),
  (78, 2, 48, '5.2', 'elective', 5),
  (79, 2, 49, '5.2', 'elective', 5),
  (80, 2, 51, '5.2', 'elective', 5),
  (81, 2, 53, '5.3', 'required', 5),
  (82, 2, 54, '5.2', 'elective', 5),
  (83, 2, 55, '5.2', 'elective', 5),
  (84, 2, 56, '5.2', 'elective', 5),
  (85, 2, 57, '5.2', 'elective', 5),
  (86, 3, 1, '1.1', 'required', 1),
  (87, 3, 2, '1.2', 'required', 1),
  (88, 3, 3, '1.3', 'required', 1),
  (89, 3, 4, '1.4.1', 'required', 1),
  (90, 3, 5, '1.4.2', 'required', 1),
  (91, 3, 6, '1.4.3', 'required', 1),
  (92, 3, 7, '3.2', 'elective', 3),
  (93, 3, 8, '2.1', 'required', 2),
  (94, 3, 10, '2.2', 'required', 2),
  (95, 3, 11, '3.2', 'elective', 3),
  (96, 3, 12, '3.2', 'elective', 3),
  (97, 3, 13, '2.3', 'required', 2),
  (98, 3, 19, '3.1', 'required', 3),
  (99, 3, 20, '3.2', 'elective', 3),
  (100, 3, 21, '3.2', 'elective', 3),
  (101, 3, 22, '3.2', 'elective', 3),
  (102, 3, 23, '3.2', 'elective', 3),
  (103, 3, 24, '3.2', 'elective', 3),
  (104, 3, 25, '3.2', 'elective', 3),
  (105, 3, 26, '3.2', 'elective', 3),
  (106, 3, 27, '3.2', 'elective', 3),
  (107, 3, 28, '3.2', 'elective', 3),
  (108, 3, 29, '3.2', 'elective', 3),
  (109, 3, 30, '3.2', 'elective', 3),
  (110, 3, 34, '4.2', 'elective', 4),
  (111, 3, 35, '4.1', 'required', 4),
  (112, 3, 37, '4.2', 'elective', 4),
  (113, 3, 38, '4.2', 'elective', 4),
  (114, 3, 39, '4.2', 'elective', 4),
  (115, 3, 40, '4.2', 'elective', 4),
  (116, 3, 41, '4.2', 'elective', 4),
  (117, 3, 42, '4.2', 'elective', 4),
  (118, 3, 43, '4.2', 'elective', 4),
  (119, 3, 44, '4.2', 'elective', 4),
  (120, 3, 48, '5.2', 'elective', 5),
  (121, 3, 49, '5.2', 'elective', 5),
  (122, 3, 51, '5.2', 'elective', 5),
  (123, 3, 52, '5.1', 'required', 5),
  (124, 3, 53, '5.3', 'required', 5),
  (125, 3, 54, '5.2', 'elective', 5),
  (126, 3, 55, '5.2', 'elective', 5),
  (127, 3, 56, '5.2', 'elective', 5),
  (128, 3, 57, '5.2', 'elective', 5),
  (129, 4, 1, '1.1', 'required', 1),
  (130, 4, 2, '1.2', 'required', 1),
  (131, 4, 3, '1.3', 'required', 1),
  (132, 4, 4, '1.4.1', 'required', 1),
  (133, 4, 5, '1.4.2', 'required', 1),
  (134, 4, 6, '1.4.3', 'required', 1),
  (135, 4, 7, '3.2', 'elective', 3),
  (136, 4, 9, '2.1', 'required', 2),
  (137, 4, 10, '2.2', 'required', 2),
  (138, 4, 11, '3.2', 'elective', 3),
  (139, 4, 12, '3.2', 'elective', 3),
  (140, 4, 13, '2.3', 'required', 2),
  (141, 4, 18, '3.1', 'required', 3),
  (142, 4, 20, '3.2', 'elective', 3),
  (143, 4, 21, '3.2', 'elective', 3),
  (144, 4, 22, '3.2', 'elective', 3),
  (145, 4, 23, '3.2', 'elective', 3),
  (146, 4, 24, '3.2', 'elective', 3),
  (147, 4, 25, '3.2', 'elective', 3),
  (148, 4, 26, '3.2', 'elective', 3),
  (149, 4, 27, '3.2', 'elective', 3),
  (150, 4, 28, '3.2', 'elective', 3),
  (151, 4, 29, '3.2', 'elective', 3),
  (152, 4, 30, '3.2', 'elective', 3),
  (153, 4, 32, '4.1', 'required', 4),
  (154, 4, 37, '4.2', 'elective', 4),
  (155, 4, 38, '4.2', 'elective', 4),
  (156, 4, 39, '4.2', 'elective', 4),
  (157, 4, 40, '4.2', 'elective', 4),
  (158, 4, 41, '4.2', 'elective', 4),
  (159, 4, 42, '4.2', 'elective', 4),
  (160, 4, 43, '4.2', 'elective', 4),
  (161, 4, 44, '4.2', 'elective', 4),
  (162, 4, 48, '5.1', 'required', 5),
  (163, 4, 49, '5.1', 'required', 5),
  (164, 4, 51, '5.2', 'elective', 5),
  (165, 4, 53, '5.3', 'required', 5),
  (166, 4, 54, '5.1', 'required', 5),
  (167, 4, 55, '5.2', 'elective', 5),
  (168, 4, 56, '5.2', 'elective', 5),
  (169, 4, 57, '5.2', 'elective', 5),
  (170, 5, 1, '1.1', 'required', 1),
  (171, 5, 2, '1.2', 'required', 1),
  (172, 5, 3, '1.3', 'required', 1),
  (173, 5, 4, '1.4.1', 'required', 1),
  (174, 5, 5, '1.4.2', 'required', 1),
  (175, 5, 6, '1.4.3', 'required', 1),
  (176, 5, 7, '3.2', 'elective', 3),
  (177, 5, 8, '2.1', 'required', 2),
  (178, 5, 10, '3.2', 'elective', 3),
  (179, 5, 11, '3.2', 'elective', 3),
  (180, 5, 12, '2.2', 'required', 2),
  (181, 5, 13, '2.3', 'required', 2),
  (182, 5, 17, '3.1', 'required', 3),
  (183, 5, 20, '3.2', 'elective', 3),
  (184, 5, 21, '3.2', 'elective', 3),
  (185, 5, 22, '3.2', 'elective', 3),
  (186, 5, 23, '3.2', 'elective', 3),
  (187, 5, 24, '3.2', 'elective', 3),
  (188, 5, 25, '3.2', 'elective', 3),
  (189, 5, 26, '3.2', 'elective', 3),
  (190, 5, 27, '3.2', 'elective', 3),
  (191, 5, 28, '3.2', 'elective', 3),
  (192, 5, 29, '3.2', 'elective', 3),
  (193, 5, 30, '3.2', 'elective', 3),
  (194, 5, 34, '4.1', 'required', 4),
  (195, 5, 37, '4.2', 'elective', 4),
  (196, 5, 38, '4.2', 'elective', 4),
  (197, 5, 39, '4.2', 'elective', 4),
  (198, 5, 40, '4.2', 'elective', 4),
  (199, 5, 41, '4.2', 'elective', 4),
  (200, 5, 43, '4.2', 'elective', 4),
  (201, 5, 44, '4.2', 'elective', 4),
  (202, 5, 48, '5.2', 'elective', 5),
  (203, 5, 49, '5.2', 'elective', 5),
  (204, 5, 51, '5.1', 'required', 5),
  (205, 5, 53, '5.3', 'required', 5),
  (206, 5, 54, '5.2', 'elective', 5),
  (207, 5, 55, '5.2', 'elective', 5),
  (208, 5, 56, '5.2', 'elective', 5),
  (209, 5, 57, '5.2', 'elective', 5),
  (210, 6, 1, '1.1', 'required', 1),
  (211, 6, 2, '1.2', 'required', 1),
  (212, 6, 3, '1.3', 'required', 1),
  (213, 6, 4, '1.4.1', 'required', 1),
  (214, 6, 5, '1.4.2', 'required', 1),
  (215, 6, 6, '1.4.3', 'required', 1),
  (216, 6, 7, '3.2', 'elective', 3),
  (217, 6, 8, '2.2', 'required', 2),
  (218, 6, 9, '2.1', 'required', 2),
  (219, 6, 10, '3.2', 'elective', 3),
  (220, 6, 11, '3.2', 'elective', 3),
  (221, 6, 12, '3.2', 'elective', 3),
  (222, 6, 13, '2.3', 'required', 2),
  (223, 6, 14, '3.1', 'required', 3),
  (224, 6, 20, '3.2', 'elective', 3),
  (225, 6, 21, '3.2', 'elective', 3),
  (226, 6, 22, '3.2', 'elective', 3),
  (227, 6, 23, '3.2', 'elective', 3),
  (228, 6, 24, '3.2', 'elective', 3),
  (229, 6, 25, '3.2', 'elective', 3),
  (230, 6, 26, '3.2', 'elective', 3),
  (231, 6, 27, '3.2', 'elective', 3),
  (232, 6, 28, '3.2', 'elective', 3),
  (233, 6, 29, '3.2', 'elective', 3),
  (234, 6, 30, '3.2', 'elective', 3),
  (235, 6, 31, '4.1', 'required', 4),
  (236, 6, 37, '4.2', 'elective', 4),
  (237, 6, 38, '4.2', 'elective', 4),
  (238, 6, 39, '4.2', 'elective', 4),
  (239, 6, 40, '4.2', 'elective', 4),
  (240, 6, 41, '4.2', 'elective', 4),
  (241, 6, 42, '4.2', 'elective', 4),
  (242, 6, 43, '4.2', 'elective', 4),
  (243, 6, 44, '4.2', 'elective', 4),
  (244, 6, 46, '5.1.1', 'required', 5),
  (245, 6, 47, '5.1.2', 'required', 5),
  (246, 6, 48, '5.2', 'elective', 5),
  (247, 6, 49, '5.2', 'elective', 5),
  (248, 6, 51, '5.2', 'elective', 5),
  (249, 6, 53, '5.3', 'required', 5),
  (250, 6, 54, '5.2', 'elective', 5),
  (251, 6, 55, '5.2', 'elective', 5),
  (252, 6, 56, '5.2', 'elective', 5),
  (253, 6, 57, '5.2', 'elective', 5),
  (254, 7, 58, '1.1', 'required', 1),
  (255, 7, 59, '1.2', 'required', 1),
  (256, 8, 60, '1.0', 'other', 1),
  (257, 9, 61, '294', 'elective', 3),
  (258, 9, 62, '295', 'elective', 3),
  (259, 9, 63, '297', 'elective', 3),
  (260, 9, 64, '298', 'elective', 3),
  (261, 9, 65, '291', 'elective', 4),
  (262, 9, 66, '293', 'elective', 4),
  (263, 9, 67, '299', 'elective', 4),
  (264, 9, 68, '300', 'elective', 4),
  (265, 10, 69, '270', 'elective', 4),
  (266, 10, 70, '271', 'elective', 4),
  (267, 10, 71, '272', 'elective', 4),
  (268, 10, 72, '273', 'elective', 4),
  (269, 10, 73, '274', 'elective', 4),
  (270, 10, 74, '275', 'elective', 4),
  (271, 10, 75, '276', 'elective', 4),
  (272, 10, 76, '277', 'elective', 4),
  (273, 10, 77, '278', 'elective', 4),
  (274, 10, 78, '279', 'elective', 4),
  (275, 9, 79, '290', 'elective', 5),
  (276, 9, 80, '292', 'elective', 5),
  (277, 9, 81, '296', 'elective', 5),
  (278, 11, 82, '320', 'elective', 5),
  (279, 11, 83, '318', 'elective', 5),
  (280, 11, 84, '312', 'elective', 5),
  (281, 11, 85, '319', 'elective', 5),
  (282, 11, 86, '316', 'elective', 5),
  (283, 11, 87, '315', 'elective', 5),
  (284, 11, 88, '321', 'elective', 5),
  (285, 11, 89, '311', 'elective', 5),
  (286, 11, 90, '313', 'elective', 5),
  (287, 11, 91, '314', 'elective', 5),
  (288, 11, 92, '317', 'elective', 5);
/*!40000 ALTER TABLE `pathway_projects` ENABLE KEYS */
;
UNLOCK TABLES;
--
...
CREATE TABLE `pathways` (
  ...
  `status` enum('active', 'inactive', 'obsolete') NOT NULL,
  PRIMARY KEY (`id`)
...
VALUES (
  ...
  (2, 'Engaging Humor', 'EH', 'pathway', 'active'),
  (
    3,
...
VALUES (
    1,
    'ACHIEVEMENTS_EDIT',
    'Permission to achievements edit',
    'achievements',
    'achievements',
    'edit',
    '2026-01-15 07:42:37'
  ...
  (
    2,
    'ACHIEVEMENTS_VIEW',
    'Permission to achievements view',
    'achievements',
    'achievements',
    'view',
    '2026-01-15 07:42:37'
  ...
  (
    5,
    'BOOKING_ASSIGN_ALL',
    'Permission to booking assign all',
    'booking',
    'booking',
    'assign_all',
    '2026-01-15 07:42:37'
  ...
  (
    6,
    'BOOKING_BOOK_OWN',
    'Permission to booking book own',
    'booking',
    'booking',
    'book_own',
    '2026-01-15 07:42:37'
  ...
  (
    7,
    'CONTACT_BOOK_EDIT',
    'Permission to contact book edit',
    'contacts',
    'contact_book',
    'edit',
    '2026-01-15 07:42:37'
  ...
  (
    8,
    'CONTACT_BOOK_VIEW',
    'Permission to contact book view',
    'contacts',
    'contact_book',
    'view',
    '2026-01-15 07:42:37'
  ...
  (
    9,
    'PATHWAY_LIB_EDIT',
    'Permission to pathway lib edit',
    'pathways',
    'pathway_library',
    'edit',
    '2026-01-15 07:42:37'
  ...
  (
    10,
    'PATHWAY_LIB_VIEW',
    'Permission to pathway lib view',
    'pathways',
    'pathway_library',
    'view',
    '2026-01-15 07:42:37'
  ...
  (
    12,
    'SETTINGS_EDIT_ALL',
    'Permission to settings edit all',
    'settings',
    'settings',
    'edit_all',
    '2026-01-15 07:42:37'
  ...
  (
    13,
    'SETTINGS_VIEW_ALL',
    'Permission to settings view all',
    'settings',
    'settings',
    'view_all',
    '2026-01-15 07:42:37'
  ...
  (
    ...
    'Permission to speech logs edit all',
    'speech_logs',
    'speech_logs',
    'edit_all',
    '2026-01-15 07:42:37'
  ...
  (
    ...
    'Permission to speech logs view all',
    'speech_logs',
    'speech_logs',
    'view_all',
    '2026-01-15 07:42:37'
  ...
  (
    ...
    'Permission to speech logs view own',
    'speech_logs',
    'speech_logs',
    'view_own',
    '2026-01-15 07:42:37'
  ...
  (
    ...
    'Permission to voting track progress',
    'voting',
    'voting',
    'track_progress',
    '2026-01-15 07:42:37'
  ...
  (
    18,
    'VOTING_VIEW_RESULTS',
    'Permission to voting view results',
    'voting',
    'voting',
    'view_results',
    '2026-01-15 07:42:37'
...
VALUES (
  ...
  (
    ...
    'Defining a general purpose and a specific purpose; Topic and Purpose Worksheet; The Speech Outline Worksheet',
  ...
  (
    ...
    5,
    7,
    'Evaluation and Feedback (required)\nIn this project, you will learn strategies to effectively receive feedback and apply it to improve your public speaking and leadership skills. You will also learn how to deliver tactful and constructive feedback. You will gain an understanding of how to identify the type of feedback an individual requires and expects, the importance of using positive language in feedback, and the difference between feedback and advice.',
    'This project includes two 5- to 7-minute speeches. Choose any topic for your first Evaluation and Feedback speech. After your speech, carefully review the feedback you received from your evaluator. At a future club meeting, present your second Evaluation and Feedback speech. You may create a new speech, revise your first Evaluation and Feedback speech, or present your first Evaluation and Feedback speech again if you are focusing on feedback you received on how you delivered your first Evaluation and Feedback speech. Your second speech should reflect some or all of the feedback you received after your first Evaluation and Feedback speech. Finally, after you have completed both speeches, serve as an evaluator at a club meeting and deliver constructive feedback about another member’s presentation.',
    'The purpose of this project is to practice applying feedback and serve as a speech evaluator during a club meeting.',
  ...
  (
    6,
    'Evaluation and Feedback-Individual Evaluation',
    'Evaluation',
    2,
    3,
    'Evaluation and Feedback (required)\nIn this project, you will learn strategies to effectively receive feedback and apply it to improve your public speaking and leadership skills. You will also learn how to deliver tactful and constructive feedback. You will gain an understanding of how to identify the type of feedback an individual requires and expects, the importance of using positive language in feedback, and the difference between feedback and advice.',
  ...
  (
    ...
    5,
    7,
    'Know your sense of humor (elective)',
  ...
  (
    ...
    'The purpose of this project is to deliver a speech with awareness of your intentional and unintentional body language, as well as to learn, practice, and refine how you use nonverbal communication when delivering a speech.',
    '■ A 5- to 7-minute speech',
    'https://www.youtube.com/watch?v=ZK3jSXYBNak\n\n<iframe width=\"560\" height=\"315\" src=\"https://www.youtube.com/embed/eOoCe3An4VE?si=1t6Y5n9_VA6Qk0yZ\" title=\"YouTube video player\" frameborder=\"0\" allow=\"accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share\" referrerpolicy=\"strict-origin-when-cross-origin\" allowfullscreen></i'
  ),
  (
    13,
    ...
    5,
    7,
    'Introduction to Toastmasters Mentoring (required)\nThis project introduces the value of mentorship and the Toastmasters view of mentors and protégés.',
    'Write and present a 5- to 7-minute speech about a time when you were a protégé. Share the impact and importance of having a mentor. This speech is not a report on the content of this project.',
  ...
  (
    ...
    5,
    7,
    'Develop a Communication Plan (required)\nThis project focuses on how to formulate a central message and develop a communication plan for a target audience.',
    'Develop a communication plan for any event or situation. The plan may be for a real or hypothetical need. At a club meeting, present a 5- to 7-minute speech about your experience. You may choose to speak about the planning process, the benefits of developing a plan, or the impact of your plan if you implemented it. Show your vice president education your completed plan to receive credit for this project.',
    'The purpose of this project is to practice developing a communication plan.',
    'Developing a communication plan; The Write a Communication Plan resource',
  ...
  (
    ...
    5,
    7,
    'Engage Your Audience with Humor (required)',
    '',
    'The purpose of this project is for the member to determine their style of humor and apply it to a speech that centers around a central message.',
    '',
    ''
  ),
  (
    ...
    5,
    7,
    'Negotiate the Best Outcome (required)\nThis project focuses on identifying negotiation styles, engaging in mutually beneficial discussions, and finding and building common ground.\n\n',
    'Develop a 5- to 7-minute speech about a past or upcoming negotiation in your life. The negotiation must be one that you have participated in or will participate in. You may choose to reflect on the strategies you used or those that you believe would be the most beneficial in the future. Your speech can be persuasive, humorous, informational, or crafted in any style that appeals to you and supports your speech content.',
    'The purpose of this project is to learn about different types of negotiation and the strategies that can be used when negotiating.',
    'Analyzing a past or future negotiation in your life; The Negotiation Goal Setting resource',
    'This project includes: \n■ Analyzing a past or future negotiation in your life\n■ The Negotiation Goal Setting resource\n■ A 5- to 7-minute speech'
  ),
  (
    17,
    'Persuasive Speaking',
    ...
    'Choose any topic that lends itself to speaking persuasively and prepare a speech. Present your 5- to 7-minute speech at a club meeting. If your vice president education approves a non-club event or group, your evaluator must be present for your speech.',
  ...
  (
    ...
    5,
    7,
    'Understanding Conflict Resolution (required)\nThis project is designed to introduce conflict resolution strategies and provide an opportunity to resolve a conflict scenario within an interactive activity.',
    'Complete the conflict resolution video activity in the project. Prepare a 5- to 7-minute speech to discuss how you manage conflict, how you can develop a stronger strategy, and your best attributes in a conflict situation. You may also share the impact of the video activity. Your speech may be humorous, informational, or any style that appeals to you. This project is not a report on or a critique of the content of this project.',
    'The purpose of this project is to develop or enhance your understanding of the steps and strategies to address conflict.',
  ...
  (
    ...
    5,
    7,
    'Understanding Emotional Intelligence (required)\nThis project addresses elements of emotional intelligence. It is designed to help you understand your own emotions and the emotions of others.',
    'For a minimum of two weeks, keep a journal about your emotions and how they impact you and others. Discuss the impact of tracking your emotions in a 5- to 7-minute speech at a club meeting. (Note: You are not required to share the intimacies of your experience.) Finally, submit the signed Project Completion Form to your vice president education to indicate you completed your journal.',
    'The purpose of this project is to cultivate an understanding of how your emotions impact your relationships. It is also designed to help you identify how others’ emotions impact your emotional state.',
    'A journal you maintain for a minimum of two weeks; The Project Completion Form',
  ...
  (
    ...
    5,
    7,
    'Connect with Storytelling (elective)\nThis project addresses storytelling techniques and descriptive skills to help make every speech relatable and interesting.',
    'Choose an established story, a story about your life, or a fictional tale of your own creation. Deliver the 5- to 7-minute speech at a club meeting.',
  ...
  (
    ...
    5,
    7,
    'Creating Effective Visual Aids (elective)\nThis project addresses effective methods for choosing the best visual aid for your presentation along with the creation and use of each type.',
    'Choose a speech topic that lends itself well to using visual aids. Create at least one but no more than three visual aids to enhance your presentation. Deliver your 5- to 7-minute presentation at a club meeting.',
  ...
  (
    ...
    3,
    4,
    'Deliver Social Speeches (elective)\nThis project addresses the skills needed to compose a speech for a social occasion including a toast, eulogy, an acceptance speech and a speech praising an individual or group.',
    'Develop two different social speeches—each 3 to 4 minutes—and present them at two separate club meetings. You may choose any two types of social speeches that appeal to you or that you would like to practice.',
  ...
  (
    ...
    'Recording your daily moods and attitudes for a minimum of two weeks; The Project Completion Form',
  ...
  (
    ...
    'The Prepare to Network resource; Attending a networking event; The Project Completion Form',
  ...
  (
    ...
    'The Identifying Your Skills Worksheet; The Interviewer Instructions resource',
  ...
  (
    ...
    5,
    7,
    'Understanding Vocal Variety (elective)\nThis project addresses the importance of vocal variety when giving a speech and provides activities to develop and nurture its use.\n',
    'Learn or review the importance of vocal variety. Use the exercises in this project to improve your vocal variety skills. Then, present a 5- to 7-minute speech on any topic at a club meeting. The primary focus of the evaluation is your vocal variety.',
  ...
  (
    ...
    5,
    7,
    'Manage Change (required)\nThis project focuses on how to plan for change, develop a communication plan, and identify obstacles to success.',
    'Create a change management plan for a real or hypothetical situation. You may create a plan that is based on a past change or a future change that is happening in your personal, Toastmasters, or professional life. Share your change management plan with your club in a 5- to 7-minute speech. Your speech may be humorous, informational, or any other style that appeals to you. It is not a report on what you learned from the project, but an overview of your plan and how it will benefit you and the group the change affects.',
    'The purpose of this project is to practice developing a change management plan.',
    'Creating a change management plan; The Prepare for Change Worksheet; The Write a Communication Plan resource',
  ...
  (
    ...
    5,
    7,
    'Motivate Others (required)\nThis project focuses on how people are motivated. It is designed to help you build your leadership skills by effectively motivating team members.',
    'Build a team of three to four people to help you create and complete a project to benefit your club. Use the information in the project to develop motivational strategies for each team member. After the project, you may choose to ask team members and at least one club officer to complete a 360° evaluation to give you feedback on your communication and leadership. Deliver a 5- to 7-minute speech at a club meeting about your experience. Your speech is not a report on the content of this project.',
    'The purpose of this project is to practice the skills needed to motivate team members through the completion of a project.',
    'Building and motivating a team to complete a project that benefits your club; The Team-Building Activities resource; The 360¬∞ Evaluation resource',
  ...
  (
    ...
    4,
    6,
    'The Power of Humor In an Impromptu Speech (required)',
    '',
    'The purpose of this project is for the member to develop their method for giving impromptu speeches and practice adapting rehearsed stories during a presentation.',
    '',
    ''
  ),
  (
    ...
    'Establishing or enhancing a social media presence; The Project Completion Form',
  ...
  (
    ...
    20,
    30,
    'Manage Online Meetings (elective)\nThis project addresses how to effectively conduct online meetings and webinars, prepare and organize necessary visual aids, and lead with confidence.',
    'Conduct a 20- to 25-minute online meeting with fellow Toastmasters or a 20- to 25-minute webinar with visual aids for fellow Toastmasters. You determine the topic of your meeting or webinar. Research and use software that best fits your needs and geographic area. Invite your evaluator to participate in the online meeting or webinar. If you complete your assignment with non-Toastmasters, you must receive approval from the vice president education and invite your evaluator to attend.',
    'The purpose of this project is to practice facilitating an online meeting or leading a webinar.',
    'The Online Meeting Agenda resource; The Online Meeting Basics resource; Planning and conducting a 20- to 25-minute online meeting or webinar',
  ...
  (
    ...
    'Building a team; Creating a project plan; The Project Plan resource; Completing the plan with your team',
    'This project includes: \n■ Building a team\n■ Creating a project plan\n■ The Project Plan resource\n■ A 2- to 3-minute speech about your plan\n■ Completing the plan with your team\n■ A 5- to 7-minute speech about your experience'
  ),
  (
    41,
    'Manage Projects Successfully-Experience Speech',
    'Prepared Speech',
    5,
    7,
    'Manage Projects Successfully (elective)\nThis project focuses on skills needed to effectively manage a project, develop rapport with stakeholders and cultivate strong relationships with a team.',
  ...
  (
    ...
    'Maintaining a blog and posting at least eight times in one month; The Blog Evaluation Form; The Project Completion Form',
  ...
  (
    ...
    5,
    7,
    'Deliver Your Message With Humor (required)',
    '',
    'The purpose of this project is for the member to practice developing and presenting a longer humorous speech.',
    '',
    ''
  ),
  (
    46,
    'Develop Your Vision - First Speech',
    'Prepared Speech',
    5,
    7,
    'Develop Your Vision (required)\nThis project focuses on developing a vision for your work or personal life.\n',
    ...
    'The purpose of this project is to develop a detailed vision for your personal life, professional life, or an organization.',
    'Developing a vision and establishing a plan to implement it; The Idea Map Worksheet; The Goal Setting Worksheet; The Goal Task List; The Vision Plan resource; The Project Completion Form',
  ...
  (
    47,
    'Develop Your Vision - Second Speech',
    'Prepared Speech',
    5,
    7,
    'Develop Your Vision (required)\nThis project focuses on developing a vision for your work or personal life.\n',
  ...
  (
    ...
    'Selecting, leading, and completing a project with a team; Forming and meeting with a guidance committee at least five times; The Guidance Committee Introduction resource; The Meeting Agenda resource; The Project Plan Overview resource; The Project Plan resource; The Vision Plan resource; The Event Planning Worksheet; The 360¬∞ Evaluation resource',
  ...
  (
    ...
    'Build a team of three to four people to help you create and complete a project to benefit your club. Use the information in the project to develop motivational strategies for each team member. After the project, you may choose to ask team members and at least one club officer to complete a 360° evaluation to give you feedback on your communication and leadership. Deliver a 5- to 7-minute speech at a club meeting about your experience. Your speech is not a report on the content of this project.',
    'The purpose of this project is to practice the skills needed to motivate team members through the completion of a project.',
    'Building‚ÄÇand‚ÄÇmotivating‚ÄÇa‚ÄÇteam‚ÄÇto‚ÄÇcomplete‚ÄÇa‚ÄÇproject‚ÄÇthat‚ÄÇbenefits‚ÄÇyour‚ÄÇclub; The‚ÄÇTeam-Building‚ÄÇActivities‚ÄÇresource; The‚ÄÇ360¬∞‚ÄÇEvaluation‚ÄÇresource',
    'This project includes: \n■ Building and motivating a team to complete a project that benefits your club\n■ The Team-Building Activities resource\n■ The 360° Evaluation resource\n■ A 5- to 7-minute speech'
  ),
  (
    53,
  ...
  (
    ...
    'The Ethical Framework resource; Organizing and moderating a panel discussion as well as a question-and-answer session',
  ...
  (
    ...
    'Serving in a volunteer leadership role for a minimum of six months; Conducting a 360¬∞ evaluation of your leadership skills; Creating a succession plan; The Succession Plan resource; The 360¬∞ Evaluation resource',
  ...
  (
    ...
    'Facilitating a lessons learned meeting; Documenting the results of the lessons learned meeting; The 360¬∞ Evaluation resource; The Lessons Learned Response Log; The Metrics Log',
  ...
  (
    ...
    'Planning and moderating a 20- to 40-minute panel discussion; The Panelist Basics resource; The Project Completion Form',
  ...
  (
    ...
    '',
    '',
    'The purpose of this second speech is for the member to share some aspect of his or her experience completing the project.',
    '',
    ''
  ),
  (
  ...
  (
    ...
    10,
    15,
    'Presentation from series: Successful Club Series',
    NULL,
  ...
  (
    ...
    10,
    15,
    'Presentation from series: Better Speaker Series',
    NULL,
    'Educational Presentation',
    'View resources',
    NULL
  ...
  (
    ...
    10,
    15,
    'Presentation from series: Leadership Excellence Series',
    NULL,
    'Educational Presentation',
    'View resources',
    NULL
...
CREATE TABLE `role_permissions` (
  ...
  CONSTRAINT `role_permissions_ibfk_2` FOREIGN KEY (`role_id`) REFERENCES `auth_roles` (`id`) ON DELETE CASCADE
...
CREATE TABLE `Session_Types` (
  ...
  `Predefined` tinyint(1) DEFAULT '1',
  `Valid_for_Project` tinyint(1) DEFAULT NULL,
  `Is_Hidden` tinyint(1) DEFAULT NULL,
  `role_id` int DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `Title` (`Title`),
  KEY `role_id` (`role_id`),
  CONSTRAINT `Session_Types_ibfk_1` FOREIGN KEY (`role_id`) REFERENCES `meeting_roles` (`id`)
...
VALUES (
  ...
  (
    3,
    'Toastmaster of the Evening\'s Address',
    NULL,
    0,
    2,
    0,
  ...
  (7, 'Table Topics', NULL, 0, 25, 0, 1, 1, 0, 4),
  (8, 'Generic', NULL, 0, 7, 0, 0, 0, 0, NULL),
  (
    9,
  ...
  (11, 'Networking', NULL, 0, 10, 0, 0, 0, 0, NULL),
  (
    12,
    'General Evaluator\'s Address',
    NULL,
    0,
    1,
    0,
  ...
  (15, 'Timer Report', NULL, 0, 1, 0, 1, 0, 0, 6),
  (
    16,
  ...
  (30, 'Prepared Speech', NULL, 5, 7, 0, 0, 1, 0, 8),
  (31, 'Evaluation', NULL, 2, 3, 0, 0, 1, 0, 3),
  (
    32,
    'Section',
    NULL,
  ...
  (36, 'Topics Speech', NULL, 2, 3, 0, 0, 0, 1, 9),
  (
    37,
    'Introductory Mentor',
    NULL,
  ...
  (40, 'Debate', NULL, NULL, NULL, 0, 0, 0, 1, 19),
  (41, 'Panelist', NULL, NULL, NULL, 0, 0, 0, 1, 18),
  (
    42,
    'Meeting Manager',
    NULL,
  ...
  (45, 'Club Election', NULL, 0, 60, 0, 1, 0, 0, 15),
  (
    46,
    'Contest Chair Address',
    NULL,
    1,
    5,
    0,
  ...
  (58, 'Backup Speaker', '', 5, 7, 0, 0, 0, 1, NULL);
...
;
INSERT INTO `tickets`
VALUES (1, 'Early-bird', 0, NULL, NULL),
  (2, 'Cancelled', 0, NULL, NULL),
  (3, 'Walk-in', 0, NULL, NULL),
  (4, 'Officer', 0, NULL, NULL),
  (5, 'Coupon', 0, NULL, NULL),
  (6, 'Unpaid', 0, NULL, NULL),
  (7, 'Role-taker', 0, NULL, NULL);
...
;
-- Dump completed on 2026-01-25 23:01:56